...
import { Container, Button, Typography, Paper, Snackbar, Box } from '@mui/material'
            ...
            <div style={{ display: 'flex' }}>
              <div style={{ width: 210 }}>
                <Select
                  ...
                  onChange={e => handleChangeChair(e)}
